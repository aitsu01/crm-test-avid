...
const model = defineModel<File | null | undefined>();
            ...
            >
                <template #empty>
                    <div class="flex flex-col items-center justify-center space-y-2 py-3 pb-2">
                        ...
                        <p class="text-muted-color">Trascina il file qui per caricare.</p>
                    </div>
                </template>

                <template #content="{ files, removeFileCallback }">
                    <div v-for="(file, index) of files" :key="file.name + file.type + file.size" class="flex w-full min-w-0 items-center gap-4 py-2">
